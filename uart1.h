...
#ifndef	_Include_uart1_h
#define	_Include_uart1_h
...
********************************************************************/
#define UART1DataReceived() (U1STAbits.URXDA)

void UART1PutHex4( int d );

//
//	uart2Çuart1Ç…ç∑Çµë÷Ç¶.
//

#define	_Convert_uart2_h

#ifdef	_Convert_uart2_h

#define	UART2GetBaudError		UART1GetBaudError
#define	UART2GetChar            UART1GetChar
#define	UART2Init               UART1Init
#define	UART2IsPressed          UART1IsPressed
#define	UART2PrintString        UART1PrintString
#define	UART2PutChar            UART1PutChar
#define	UART2PutDec             UART1PutDec
#define	UART2PutHex             UART1PutHex
#define	UART2PutHex4            UART1PutHex4
